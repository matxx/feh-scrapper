        ...
        included do
          ...
          const_set(
            :ABBREVIATED_NAME,
            {
              ...
              const_get(:INT_ID_CORRIN_F_ADRIFT) => 'Ad!Corrin(F)',
            }.freeze,
          )
          ...
          const_set(
            ...
            {
              const_get(:INT_ID_EIRIKA_TOME) => 'Tome',
              const_get(:INT_ID_CHROM_CAV) => 'Cav',
              const_get(:INT_ID_REINHARDT_SWORD) => 'Sword',
              const_get(:INT_ID_OLWEN_GREEN) => 'Green',
              const_get(:INT_ID_HINOKA_BOW) => 'Bow',
              const_get(:INT_ID_NINO_FLYING) => 'Fly',
              const_get(:INT_ID_OLIVIA_FLYING) => 'Fly',

              const_get(:INT_ID_MARTH_FE13) => 'FE13',
              const_get(:INT_ID_ANNA_FE13) => 'FE13',
              const_get(:INT_ID_SELENA_FE8) => 'FE8',
              # const_get(:INT_ID_HILDA_FE16) => 'FE16',
              const_get(:INT_ID_HILDA_FE4) => 'FE4',
              # const_get(:INT_ID_ARTHUR_FE14) => 'FE14',
              const_get(:INT_ID_ARTHUR_FE4) => 'FE4',
