  ...
  module Fandoms
    module DuoHeroes
      ...
      def scrap_duo_heroes
        ...
        duo_heroes_with_same_pagename = all_duo_heroes.group_by { |x| x['Page'] }.select { |_, v| v.size > 1 }
        errors[:duo_heroes_with_same_pagename] = duo_heroes_with_same_pagename.keys if duo_heroes_with_same_pagename.any?
      ...
      def fill_units_with_duo_duel_scores
        all_duo_heroes.each do |hero|
          ...
          next (errors[:unknown_duo_hero] << hero) if unit.nil?
